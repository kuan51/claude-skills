...
- **Annex A (93 entries) is the stronger half.** Four themes of 37/8/14/34 terminating at A.5.37, A.6.8, A.7.14 and A.8.34, summing to 93. Each theme's published count equals its own terminal number, so the set is arithmetically closed and a wrong source is detectable rather than merely outvoted. Two independent full lists agree on all 93 assignments; the numbering was additionally checked against the contents of an official ISO/IEC 27002:2022 preview.
