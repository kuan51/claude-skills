...
After registering, tell the user it's done -- and restate the non-authoritative/citation-backed caveat from `invariants.md` for this tier -- then immediately continue into [Import](import.md) (offering it, not forcing it).
