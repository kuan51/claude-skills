...
The main loop works through a certification's controls in chunks, asks the user where each one
actually stands, and records the answer through `apply-assessment.js`. Resumable. It picks up the
...
one. An interruption costs at most a few controls.
