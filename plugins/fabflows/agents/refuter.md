...
- **Never install anything.** A missing test runner or dependency, or a command you are denied, makes the verdict `BLOCKED`, with what stopped you. Never ACCEPT a change you could not test, and never ask for rework the builder cannot do.
