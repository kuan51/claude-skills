...
|----|-------|--------|------|------------|---------------|
| [DEC-0012](decisions/DEC-0012-lead-runs-fable-at-medium-effort-delegate-on-context-volume.md) | Lead runs Fable at medium effort; delegate on context volume | proposed | 2026-09-17 | - | - |
