...
| _artifact_label | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:978` |
| _artifact_paths | function | `plugins/docs-warden/test/test_scripts.py:377` |
| _artifact_present | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:969` |
| _artifact_satisfied | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:983` |
| _audit_check | function | `plugins/docs-warden/test/test_scripts.py:97` |
| _audit_row | function | `plugins/docs-warden/test/test_scripts.py:2061` |
...
| _compact | function | `plugins/docs-warden/test/test_scripts.py:1854` |
| _decisions_repo | function | `plugins/docs-warden/test/test_scripts.py:1833` |
| _documentation_files | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:646` |
| _domain_model | function | `plugins/docs-warden/test/test_scripts.py:2412` |
| _extract | function | `plugins/docs-warden/test/test_scripts.py:2355` |
...
| _grow | function | `plugins/docs-warden/test/test_scripts.py:1923` |
| _has_edge | function | `plugins/docs-warden/test/test_scripts.py:2363` |
| _import_audit | function | `plugins/docs-warden/test/test_scripts.py:1753` |
| _is_example_asset | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:659` |
...
| _link_dir | function | `plugins/docs-warden/test/test_scripts.py:2256` |
| _lint_entry | function | `plugins/docs-warden/test/test_scripts.py:1378` |
| _lint_runner | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:770` |
...
| _only_note | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:93` |
| _ontology_audit_repo | function | `plugins/docs-warden/test/test_scripts.py:2460` |
| _ontology_repo | function | `plugins/docs-warden/test/test_scripts.py:2328` |
...
| _relative_link_targets | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:664` |
| _resolve_standard | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1005` |
| _rule_qms_record | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:910` |
| _rule_trace_requirements | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:934` |
| _runlog_warnings | function | `plugins/docs-warden/test/test_scripts.py:251` |
| _shown | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:508` |
| _snake_to_pascal | function | `plugins/docs-warden/skills/ontological-documentation/scripts/extract_concepts.py:71` |
| _standards_entries | function | `plugins/docs-warden/test/test_scripts.py:1526` |
| _standards_entry | function | `plugins/docs-warden/test/test_scripts.py:1544` |
| _standards_label | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1238` |
...
| _unread_note | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:98` |
| _waivable | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:121` |
| _waive | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1213` |
...
| audit | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1179` |
...
| check | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:85` |
| check_adr_immutability | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:325` |
| check_adr_index | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:425` |
| check_front_matter | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:264` |
| check_generated_docs | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:520` |
| check_glossary_reject_terms | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:835` |
| check_line | function | `plugins/docs-warden/skills/docs-warden/scripts/adr_compact.py:105` |
| check_links | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:678` |
| check_lint | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:786` |
| check_manifest | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:145` |
| check_ontology | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:442` |
| check_phi_secrets | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:882` |
| check_readme_shape | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1112` |
| check_required_files | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:211` |
| check_standards | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1038` |
...
| git | function | `plugins/docs-warden/skills/docs-warden/scripts/_common.py:295` |
| is_digest | function | `plugins/docs-warden/skills/docs-warden/scripts/adr_compact.py:87` |
| is_git_repo | function | `plugins/docs-warden/skills/docs-warden/scripts/_common.py:313` |
...
| main | function | `plugins/docs-warden/skills/docs-warden/scripts/adr_compact.py:123` |
| markdown_docs | function | `plugins/docs-warden/skills/docs-warden/scripts/_common.py:317` |
...
| render_aggregate | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1265` |
...
| render_single | function | `plugins/docs-warden/skills/docs-warden/scripts/audit.py:1252` |
...
| split | function | `plugins/docs-warden/skills/docs-warden/scripts/adr_compact.py:96` |
| strip_code | function | `plugins/docs-warden/skills/docs-warden/scripts/_common.py:331` |
...
| test_a_real_shared_artifact_names_its_co_claimant_in_both_rows | function | `plugins/docs-warden/test/test_scripts.py:1659` |
...
| test_a_shared_artifact_is_named_in_every_row_that_wants_it | function | `plugins/docs-warden/test/test_scripts.py:1590` |
| test_a_standard_with_a_broken_entry_is_not_named_as_a_co_claimant | function | `plugins/docs-warden/test/test_scripts.py:1713` |
...
| test_adr_compact_archives_only_decided_records | function | `plugins/docs-warden/test/test_scripts.py:1996` |
| test_adr_compact_archives_the_oldest_25_into_a_digest | function | `plugins/docs-warden/test/test_scripts.py:1870` |
| test_adr_compact_does_nothing_below_the_threshold | function | `plugins/docs-warden/test/test_scripts.py:1860` |
| test_adr_compact_dry_run_writes_nothing | function | `plugins/docs-warden/test/test_scripts.py:1912` |
| test_adr_compact_never_archives_a_digest | function | `plugins/docs-warden/test/test_scripts.py:1935` |
| test_adr_compact_outside_a_git_repository | function | `plugins/docs-warden/test/test_scripts.py:2020` |
| test_adr_compact_refuses_a_dirty_tree | function | `plugins/docs-warden/test/test_scripts.py:1966` |
| test_adr_compact_refuses_to_overwrite_an_archived_file | function | `plugins/docs-warden/test/test_scripts.py:1951` |
| test_adr_compact_section_ignores_headings_inside_code_fences | function | `plugins/docs-warden/test/test_scripts.py:2048` |
| test_adr_immutability_asks_accepted_the_same_way_load_adrs_does | function | `plugins/docs-warden/test/test_scripts.py:1151` |
| test_adr_immutability_fails_a_record_whose_front_matter_does_not_parse | function | `plugins/docs-warden/test/test_scripts.py:1170` |
...
| test_adr_pointer_has_no_table_and_link_resolves | function | `plugins/docs-warden/test/test_scripts.py:1249` |
...
| test_audit_fails_a_generator_that_never_writes_its_declared_path | function | `plugins/docs-warden/test/test_scripts.py:1188` |
| test_audit_front_matter_ignores_the_decisions_archive | function | `plugins/docs-warden/test/test_scripts.py:2090` |
...
| test_audit_still_covers_archived_records_and_skips_their_links | function | `plugins/docs-warden/test/test_scripts.py:2067` |
...
| test_check_says_why_compaction_waits | function | `plugins/docs-warden/test/test_scripts.py:2107` |
| test_concept_categories_reference_matches_the_code | function | `plugins/docs-warden/test/test_scripts.py:2444` |
| test_decisions_check_hook_after_edit | function | `plugins/docs-warden/test/test_scripts.py:2212` |
| test_decisions_check_hook_keeps_the_edited_path | function | `plugins/docs-warden/test/test_scripts.py:2268` |
| test_decisions_check_hook_reads_utf8_input | function | `plugins/docs-warden/test/test_scripts.py:2305` |
| test_decisions_check_hook_speaks_only_at_50 | function | `plugins/docs-warden/test/test_scripts.py:2184` |
| test_digest_tag_matches_in_any_case_and_only_whole | function | `plugins/docs-warden/test/test_scripts.py:2169` |
...
| test_domain_model_is_idempotent_and_check_detects_a_hand_edit | function | `plugins/docs-warden/test/test_scripts.py:2418` |
...
| test_extractor_reads_all_four_languages_and_categorises_by_name | function | `plugins/docs-warden/test/test_scripts.py:2367` |
| test_extractor_says_so_instead_of_reporting_an_empty_repo | function | `plugins/docs-warden/test/test_scripts.py:2399` |
...
| test_generated_docs_confines_the_declared_path_to_the_repo | function | `plugins/docs-warden/test/test_scripts.py:1208` |
| test_glossary_to_vale_writes_the_swap_rule_for_a_rejected_term | function | `plugins/docs-warden/test/test_scripts.py:1054` |
| test_links_fails_on_a_dangling_relative_link_and_passes_once_it_resolves | function | `plugins/docs-warden/test/test_scripts.py:1289` |
| test_links_ignores_anchors_and_external_urls | function | `plugins/docs-warden/test/test_scripts.py:1327` |
| test_links_ignores_targets_inside_code_fences | function | `plugins/docs-warden/test/test_scripts.py:1313` |
| test_links_ignores_untracked_and_ignored_markdown_in_a_git_repo | function | `plugins/docs-warden/test/test_scripts.py:1357` |
| test_links_skips_shipped_example_assets | function | `plugins/docs-warden/test/test_scripts.py:1341` |
| test_lint_fails_when_a_blocking_tool_reports_findings | function | `plugins/docs-warden/test/test_scripts.py:1401` |
| test_lint_names_the_install_for_an_adopted_but_missing_tool | function | `plugins/docs-warden/test/test_scripts.py:1463` |
| test_lint_never_reports_a_bare_pass_when_a_tool_was_absent | function | `plugins/docs-warden/test/test_scripts.py:1430` |
| test_lint_only_warns_when_vale_alone_reports_findings | function | `plugins/docs-warden/test/test_scripts.py:1417` |
| test_lint_reports_skipped_and_says_how_to_unskip_when_nothing_is_adopted | function | `plugins/docs-warden/test/test_scripts.py:1447` |
| test_lint_runner_falls_back_to_bunx_when_only_bun_is_installed | function | `plugins/docs-warden/test/test_scripts.py:1784` |
| test_lint_runner_prefers_npx_when_both_runners_are_installed | function | `plugins/docs-warden/test/test_scripts.py:1815` |
| test_lint_runner_resolves_npx_instead_of_returning_a_bare_name | function | `plugins/docs-warden/test/test_scripts.py:1757` |
| test_lint_survives_a_tool_that_writes_non_utf8_output | function | `plugins/docs-warden/test/test_scripts.py:1477` |
| test_matrix_links_are_relative_to_the_matrix | function | `plugins/docs-warden/test/test_scripts.py:24` |
| test_ontology_check_reports_missing_stale_untagged_and_current | function | `plugins/docs-warden/test/test_scripts.py:2473` |
| test_ontology_overrides_drop_a_concept_and_a_bad_value_fails_the_manifest | function | `plugins/docs-warden/test/test_scripts.py:2508` |
...
| test_standards_accepts_an_integer_level | function | `plugins/docs-warden/test/test_scripts.py:1551` |
| test_standards_accepts_any_spelling_of_an_alternative_artifact | function | `plugins/docs-warden/test/test_scripts.py:1639` |
| test_standards_fix_points_at_whichever_file_is_actually_wrong | function | `plugins/docs-warden/test/test_scripts.py:1736` |
| test_standards_rejects_a_bare_true_where_a_level_is_required | function | `plugins/docs-warden/test/test_scripts.py:1572` |
| test_standards_rejects_a_level_on_a_standard_that_has_none | function | `plugins/docs-warden/test/test_scripts.py:1565` |
| test_standards_rejects_an_unknown_id | function | `plugins/docs-warden/test/test_scripts.py:1583` |
| test_standards_reports_a_malformed_table_entry_instead_of_crashing | function | `plugins/docs-warden/test/test_scripts.py:1692` |
| test_standards_reports_a_non_mapping_instead_of_crashing | function | `plugins/docs-warden/test/test_scripts.py:1671` |
| test_standards_runs_extra_rules_only_for_the_standard_that_declares_them | function | `plugins/docs-warden/test/test_scripts.py:1614` |
| test_status_matches_in_any_case_and_spacing | function | `plugins/docs-warden/test/test_scripts.py:2151` |
...
| test_waiting_line_names_undecided_records_not_proposed_ones | function | `plugins/docs-warden/test/test_scripts.py:2137` |
